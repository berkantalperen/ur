...
class SafetyNode(Node):
    def __init__(self):
        ...
        # Publisher for MoveIt Servo (Twist commands)
    ...
    def raw_callback(self, msg_raw):
        ...
        msg_safe.pose.orientation = msg_raw.pose.orientation # Pass through orientation (todo: clamp orientation?)
    ...
    def control_loop(self):
        ...
        try:
            ...
            self.get_logger().warn("TF Lookup Failed: base_link -> tool0", throttle_duration_sec=1.0)
            return
    ...
    def publish_visualization(self, safe_pos):
        ...
        # Bottom face
        lines = [
            corners[0], corners[1], # x-axis
            corners[2], corners[3],
            corners[0], corners[2], # y-axis
            corners[1], corners[3],
            # Top face
            corners[4], corners[5],
            corners[6], corners[7],
